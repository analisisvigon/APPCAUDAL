...
assert.match(appSource, /playerPdfCrestAuditEnabled && playerPdfCrestAudit \? \([\s\S]*?COPIAR DIAGNÓSTICO PDF/, 'el botón temporal solo aparece tras generar diagnóstico con el flag QA');
