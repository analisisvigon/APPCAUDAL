...
export const buildTacticalPlayContext = ({
  ...
  return {
    ...
    createdAt: clean(safePlay.createdAt) || null,
    updatedAt: clean(safePlay.updatedAt || safePlay.createdAt) || null,
    videoUrl: clean(safePlay.videoUrl || safePlay.video_url) || null,
