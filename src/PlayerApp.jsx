...
function PlayerApp({ client, identity, onRefreshIdentity, onSignOut, signingOut = false }) {
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-[radial-gradient(circle_at_50%_0%,rgba(61,217,255,0.10),transparent_30%),linear-gradient(180deg,#02070f_0%,#071225_52%,#030812_100%)] px-3 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-[max(0.75rem,env(safe-area-inset-top))] text-slate-100 sm:px-4 sm:py-5 lg:py-7">
